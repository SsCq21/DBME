...
//return false;
  ...
  <body style="background: url(IMG/CM.jpg);background-size:cover">
   ...
   <a href="customerTrans.jsp"><h21>ViewTransaction</h21></a>
...
String sql="select Pid,Pname,image,type,inventory,price from product";
...
<td align="center"><h4>Cart</h4></td>
<td align="center"><h4>Buy</h4></td>
</tr></thead>
